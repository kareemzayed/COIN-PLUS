            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <form method="GET" action="{{ route('admin.expenses.search') }}">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="نوع المصروف" name="expense_type"
                                    value="{{ isset($search['expense_type']) ? $search['expense_type'] : '' }}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:12%">
                                            @if (checkPermission(62))
                                                <button data-href="{{ route('admin.expenses.update', $value->id) }}"
                                                    data-expense="{{ $value }}"
                                                    class="btn btn-md btn-info update"><i class="fa fa-pen"></i></button>
                                            @endif
                                            @if (checkPermission(63))
                                                <button data-href="{{ route('admin.expenses.delete', $value->id) }}"
                                                    data-expense="{{ $value }}"
    ...
    <script>
        $(function() {
            ...
            $('.add').on('click', function() {
                ...
                modal.find('form').attr('action', '{{ route('admin.expenses.create') }}');
                modal.modal('show');
            })
