            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <form method="GET" action="{{ route('admin.purchase.search') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.user.details', $purchase->seller->id) }}"
                                                ...
                                                {{ optional($purchase->seller)->fname . ' ' . optional($purchase->seller)->lname }}
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.user.details', $purchase->buyer->id) }}"
                                                style="text-decoration: none; font-size: 14px">
                                                {{ optional($purchase->buyer)->fname . ' ' . optional($purchase->buyer)->lname }}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td style="width:12%">
                                            @if (checkPermission(20))
                                                <button data-href="{{ route('admin.purchase.update', $purchase->id) }}"
                                                    data-purchase="{{ $purchase }}"
                                                    class="btn btn-md btn-info update"><i class="fa fa-pen"></i></button>
                                            @endif

                                            @if (checkPermission(21))
                                                <button data-href="{{ route('admin.purchase.delete', $purchase->id) }}"
                                                    data-purchase="{{ $purchase }}"
    ...
    <script>
        $(function() {
            ...
            $('.add').on('click', function() {
                ...
                form[0].reset();
                modal.find('form').attr('action', '{{ route('admin.purchase.create') }}');
                modal.modal('show');
            })
