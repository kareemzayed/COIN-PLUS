                     ...
                     <div class="row">
                                    ...
                                    <div class="col-md-6 mt-3">
                                       ...
                                       <select name="email_config[smtp_encryption]" id="encryption" class="form-control selectric">
                                        <option value="tls" {{ $general->email_config->smtp_encryption == 'tls' ? 'selected' : '' }}>{{ __('TLS') }}</option>
                                        <option value="ssl" {{ $general->email_config->smtp_encryption == 'ssl' ? 'selected' : '' }}>{{ __('SSL') }}</option>
                                       </select>
