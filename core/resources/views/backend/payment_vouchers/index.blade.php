            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form">
                        <form method="GET" action="{{ route('admin.payment.vouchers.search') }}">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($payment_vouchers as $key => $voucher)
                                    <tr>
                                        <td>{{ $key + $payment_vouchers->firstItem() }}</td>
                                        ...
                                        <td style="width:14%">
                                            @if (checkPermission(30))
                                                <button
                                                    data-href="{{ route('admin.payment.voucher.update', $voucher->id) }}"
                                            ...
                                            @if (checkPermission(31))
                                                <button
                                                    data-href="{{ route('admin.payment.voucher.delete', $voucher->id) }}"
                                                    data-voucher="{{ $voucher }}"
                                            ...
                                            @if (checkPermission(53))
                                                <a href="{{ route('admin.payment.voucher.print', $voucher->id) }}"
                    ...
                    @if ($payment_vouchers->hasPages())
                        <div class="card-footer">
                            {{ $payment_vouchers->links('backend.partial.paginate') }}
                        </div>
                    @endif
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            $('.add').on('click', function() {
                ...
                modal.find('form').attr('action', '{{ route('admin.payment.voucher.create') }}');
