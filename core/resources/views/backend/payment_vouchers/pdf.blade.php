...
<head>
    ...
    <title> {{ __('Payment Voucher') }} - {{ $payment_voucher->customar_name }}</title>
        ...
        <div class="sanad-form customer-copy">
            ...
            <div class="sanad">
                <div class="content">
                    ...
                    <div class="forms">
                        <form class="sr" action=""> {{ optional($payment_voucher->currency)->code }}
                            <label for="money">
                                <input class="w-80" type="text"
                                    value="{{ number_format($payment_voucher->amount, 2) }}">
                            </label>
                        </form>
                    </div>
                </div>
            ...
            <div class="date">
                <div class="container">
                    <div class="milady">
                        <p>
                            الموافق {{ date(' d / m / Y ', strtotime($payment_voucher->created_at)) }}م
                        </p>
                    </div>
                    <div class="number">
                        <h3>
                            {{ $payment_voucher->receipt_num }}
                        </h3>
                    </div>
                    <div class="higry">
                        <p>
            ...
            <div class="forms">
                <div class="container">
                    <div class="form-1">
                        ...
                        <form action="">
                            <input class="ar" type="text" value="{{ $payment_voucher->customar_name }}">
                        </form>
                        <p>
                            Pay To The Esteemed:
                        </p>
                    ...
                    <div class="form-2">
                        ...
                        <form action="">
                            <input class="ar" type="text" value="{{ $payment_voucher->amount_in_words }}">
                        </form>
                        <p>
                            Amount:
                        </p>
                    ...
                    <div class="form-3">
                        ...
                        <form action="">
                            <input class="ar" type="text" value="{{ $payment_voucher->check_no }}">
                        </form>
                        ...
                        <form action="">
                            <input class="ar" type="text" value="{{ $payment_voucher->bank }}">
                        </form>
                        <p>
                            Bank:
                        </p>
                    ...
                    <div class="form-4">
                        ...
                        <form action="">
                            <input class="ar" type="text" value="{{ $payment_voucher->exchange_for }}">
                        </form>
                        <p>
                            Being:
                        </p>
