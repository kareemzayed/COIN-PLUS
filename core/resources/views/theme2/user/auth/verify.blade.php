    ...
    <div class="account-page">
        ...
        <div class="form-wrapper">
            <div class="inner-wrapper">
                <h2 class="title text-center">التحقق الآن</h2>
                <form action="{{ route('user.auth.verify') }}" method="POST" class="account-form">
                    @csrf
                    <input type="hidden" name="email" value="{{ $email }}">
                    <div class="mb-3">
                        <label>رمز التحقق</label>
                        <input type="code" class="form-control" name="code" placeholder="أدخل الرمز هنا">
                    </div>
                    ...
                    <div class="d-flex flex-wrap align-items-center mt-4">
                        <button type="submit" id="recaptcha" class="btn main-btn">التحقق الآن</button>
