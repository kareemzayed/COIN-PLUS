            ...
            <?php if(checkPermission(48)): ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <p>تحديث رصيد المستخدم</p>
                                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="input-group mb-3">
                                        <input type="hidden" class="form-control" name="user_id"
                                            value="<?php echo e($user->id); ?>">
                                        <input type="text" class="form-control" name="balance" placeholder="المبلغ">
                                        <input type="text" class="form-control" name="note" placeholder="ملاحظة">
                                        <button class="btn btn-primary ml-2" type="submit" name="action" value="add">
                                            <i class="fa fa-plus"></i> إيداع</button>
                                        <button class="btn btn-danger" type="submit" name="action" value="minus"> <i
                                                class="fa fa-minus"></i> سحب</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CryptoPay\core\resources\views/backend/users/details.blade.php ENDPATH**/ ?>