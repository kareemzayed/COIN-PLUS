...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('asset/admin/modules/select2/dist/css/select2.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asset/admin/css/iconpicker.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asset/admin/css/toggle.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asset/admin/css/ui.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('asset/admin/js/toggle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/admin/js/ui.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/layout/master.blade.php ENDPATH**/ ?>