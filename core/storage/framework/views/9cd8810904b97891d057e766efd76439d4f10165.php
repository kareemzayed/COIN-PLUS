    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?php echo e(route('admin.home')); ?>">
                <img src="<?php echo e(getFile('logo', $general->logo, true)); ?>" alt="شعار" style="width:50px">
            </a>
        </div>
        <ul class="sidebar-menu">
            ...
            <?php if(checkPermission(61)): ?>
                <li class="sidebar-menu-caption">إدارة المصروفات</li>
                <li
                    class="nav-item dropdown <?php echo e(menuActive(['admin.expenses.index', 'admin.expenses.search', 'admin.expenses.create', 'admin.expenses.update', 'admin.expenses.delete'])); ?>">
                    <a href="<?php echo e(route('admin.expenses.index')); ?>" class="nav-link "><i data-feather="dollar-sign"
                            style="margin-left: 10px; margin-right: 0px"></i>
            ...
            <?php if(checkPermission(65)): ?>
                <li class="sidebar-menu-caption">إدارة العملات</li>
                <li
                    class="nav-item dropdown <?php echo e(menuActive(['admin.currency.index', 'admin.currency.search', 'admin.currency.add', 'admin.currency.update'])); ?>">
                    <a href="<?php echo e(route('admin.currency.index')); ?>" class="nav-link "><i data-feather="command"
                            style="margin-left: 10px; margin-right: 0px"></i>
...
<?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>