                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="signup_bonus" placeholder="<?php echo app('translator')->get('Sign Up Bonus'); ?>"
                                            ...
                                            value="<?php echo e($general->signup_bonus); ?>">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="">Nexmo Key<a href="https://www.nexmo.com/"
                                                target="_blank">API Link</a></label>
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            ...
                                            <label for="image-upload" id="image-label">اختر ملفًا</label>
                                            <input type="file" name="logo_dr" id="image-upload" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <div id="image-preview-icon" class="image-preview"
                                            ...
                                            <label for="image-upload-icon"
                                                id="image-label-icon">اختر ملفًا</label>
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <div id="image-preview-login" class="image-preview"
                                            ...
                                            <label for="image-upload-login"
                                                id="image-label-login">اختر ملفًا</label>
                                            <input type="file" name="login_image" id="image-upload-login" />
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary float-right">تحديث الأعدادات العامة</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CryptoPay\core\resources\views/backend/setting/general_setting.blade.php ENDPATH**/ ?>