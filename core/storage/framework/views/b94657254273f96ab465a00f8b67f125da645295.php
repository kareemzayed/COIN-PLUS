                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select class="form-control" name="fund_id" id="fund_id" required>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $funds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($fund->id); ?>"><?php echo e($fund->name . ' - الرصيد الحالي: ' . number_format($fund->balance, 2) . ' ' . $general->site_currency); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/direct_purchases/index.blade.php ENDPATH**/ ?>