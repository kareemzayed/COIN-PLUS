    ...
    <div class="main-content">
        <div class="section">
            <div class="section-header pl-0 pb-3">
                <h3 class="pl-0"><?php echo e('معاملات الصندوق' . ' ' . $fund->name); ?></h3>
            </div>
            <div class="card">
                <div class="card-header">
                    <h4>
                        <a href="<?php echo e(route('admin.funds.index')); ?>" class="btn btn-outline-primary"><i
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CryptoPay\core\resources\views/backend/funds/history.blade.php ENDPATH**/ ?>