        ...
        <div class="section">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        <?php if(checkPermission(45)): ?>
                            <button class="btn btn-primary add"><i class="fa fa-plus"></i>
                                إنشاء سند قبض جديد</button>
                        <?php endif; ?>
                    </h4>
                    <div class="card-header-form">
                        <form method="GET" action="<?php echo e(route('admin.receipt.vouchers.search')); ?>">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $receipt_vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($key + $receipt_vouchers->firstItem()); ?></td>
                                        <td><?php echo e($voucher->receipt_num); ?></td>
                                        <td><?php echo e($voucher->customar_name); ?></td>
                                        <td>
                                            <?php echo e(number_format($voucher->amount, 2) . ' ' . optional($voucher->currency)->code); ?>
                                        ...
                                        <td style="width:14%">
                                            <?php if(checkPermission(26)): ?>
                                                <button
                                                    data-href="<?php echo e(route('admin.receipt.voucher.update', $voucher->id)); ?>"
                                                    data-voucher="<?php echo e($voucher); ?>"
                                                    class="btn btn-md btn-info update"><i class="fa fa-pen"></i></button>
                                            <?php endif; ?>

                                            <?php if(checkPermission(27)): ?>
                                                <button
                                                    data-href="<?php echo e(route('admin.receipt.voucher.delete', $voucher->id)); ?>"
                                                    data-voucher="<?php echo e($voucher); ?>"
                                                    class="btn btn-md btn-danger delete"><i
                                                        class="fa fa-trash"></i></button>
                                            <?php endif; ?>

                                            <?php if(checkPermission(52)): ?>
                                                <a href="<?php echo e(route('admin.receipt.voucher.print', $voucher->id)); ?>"
                    ...
                    <?php if($receipt_vouchers->hasPages()): ?>
                        <div class="card-footer">
                            <?php echo e($receipt_vouchers->links('backend.partial.paginate')); ?>
                                ...
                                <select class="form-control" name="currency_id" id="currency_id">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($currency->id); ?>" data-code="<?php echo e($currency->code); ?>">
                                            <?php echo e($currency->name . ' - ' . $currency->code); ?>
    ...
    <script>
        $(function() {
            ...
            $('.add').on('click', function() {
                ...
                modal.find('form').attr('action', '<?php echo e(route('admin.receipt.voucher.create')); ?>');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/receipt_vouchers/index.blade.php ENDPATH**/ ?>