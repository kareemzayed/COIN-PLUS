    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="row">
                ...
                <div class="custom-xxxl-3 custom-xxl-6 col-md-6 col-sm-6 col-12 mb-4">
                    <a href="<?php echo e(checkPermission(73) ? route('admin.direct.purchase.index', $dateString) : '#'); ?>"
                        style="text-decoration: none">
                        <div class="card-stat gr-bg-13">
                            ...
                            <div class="content">
                                ...
                                <h4 class="card-stat-amount">
                                    <?php if(isset($groupedProfits['App\Models\DirectPurchase'])): ?>
                                        <?php echo e(number_format($groupedProfits['App\Models\DirectPurchase']['totalProfits'], 2) . ' ' . $general->site_currency); ?><br />
                                        <?php echo e($groupedProfits['App\Models\DirectPurchase']['transactionCount'] . ' ' . 'معاملة'); ?>
                ...
                <div class="custom-xxxl-3 custom-xxl-6 col-md-6 col-sm-6 col-12 mb-4">
                    <a href="<?php echo e(checkPermission(69) ? route('admin.trans.with.currency.index', $dateString) : '#'); ?>"
                        style="text-decoration: none">
                        <div class="card-stat gr-bg-11">
                            ...
                            <div class="content">
                                ...
                                <h4 class="card-stat-amount">
                                    <?php if(isset($groupedProfits['App\Models\TransactionWithCurrency'])): ?>
                                        <?php echo e(number_format($groupedProfits['App\Models\TransactionWithCurrency']['totalProfits'], 2) . ' ' . $general->site_currency); ?><br />
                                        <?php echo e($groupedProfits['App\Models\TransactionWithCurrency']['transactionCount'] . ' ' . 'معاملة'); ?>
                ...
                <div class="custom-xxxl-3 custom-xxl-6 col-md-6 col-sm-6 col-12 mb-4">
                    <a href="<?php echo e(checkPermission(61) ? route('admin.expenses.index', $dateString) : '#'); ?>"
                        style="text-decoration: none">
                        <div class="card-stat gr-bg-12">
                            ...
                            <div class="content">
                                ...
                                <h4 class="card-stat-amount">
                                    <?php echo e(number_format($totalAmountOfExpenses, 2) . ' ' . $general->site_currency); ?><br />
                                    <?php echo e($totalExpenses . ' ' . 'مصروف'); ?>
                ...
                <div class="custom-xxxl-3 custom-xxl-6 col-md-6 col-sm-6 col-12 mb-4">
                    <a href="<?php echo e(checkPermission(39) ? route('admin.transaction', $dateString) : '#'); ?>" style="text-decoration: none">
                        <div class="card-stat gr-bg-8">
                            ...
                            <div class="content">
                                ...
                                <h4 class="card-stat-amount">
                                    <?php echo e(number_format($totalNetProfits, 2) . ' ' . $general->site_currency); ?><br />
                                </h4>
                            </div>
                        </div>
                    </a>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/profits/index.blade.php ENDPATH**/ ?>