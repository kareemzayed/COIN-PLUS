...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function updateChargeValueText(chargeType) {
            var chargeValueText = '';
            if (chargeType == 1) {
                chargeValueText = '<?php echo e($general->site_currency); ?>';
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\COIN_yas\core\resources\views/backend/transactions_with_currencies/index.blade.php ENDPATH**/ ?>